...
def train(model, device, data_loader, optimizer, epoch, mod='cos', method=1, lam=1, alpha=0):
    ...
    for batch_idx, (data, target) in enumerate(data_loader):
        ...
        if method == 0:
            ...
            loss1 = 0
            loss2 = utils.max_ce(output_subs, target, device)
        elif method == 2:
...
def main(args):
    ...
    if args.dataset == 'cifar10':
        ...
        train_loader, test_loader = utils.load_CelebA(args.batch_size, **kwargs)
    elif args.dataset == 'tinyimagenet':
        train_loader, test_loader = utils.load_TinyImageNet(args.batch_size, **kwargs)
    ...
    if args.dataset == 'celeba':
        lr_scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[20, 30], gamma=0.1)
    else:
...
def acc_party(args):
    ...
    if args.dataset == 'cifar10':
        ...
        _, test_loader = utils.load_CelebA(args.batch_size, test_batch_size=test_batch_size, **kwargs)
    elif args.dataset == 'tinyimagenet':
        _, test_loader = utils.load_TinyImageNet(args.batch_size, test_batch_size=test_batch_size, **kwargs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_party', type=int, default=1)
